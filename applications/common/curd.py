...
def get_one_by_foodId(model: db.Model, foodId):
    """
    :param model: 模型类
    :param id: id
    :return: 返回单个查询结果
    """
    return model.query.filter_by(foodId=foodId).first()

def get_one_by_foodTypeId(model: db.Model, foodTypeId):
    """
    :param model: 模型类
    :param id: id
    :return: 返回单个查询结果
    """
    return model.query.filter_by(foodTypeId=foodTypeId).first()
